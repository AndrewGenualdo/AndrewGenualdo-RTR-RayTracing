...
/*
	...
	a3_SceneObject.c
	Example of scene utility source file.
*/
...
extern inline void a3scene_initSceneObject(a3_SceneObject *sceneObject)
{
...
extern inline void a3scene_updateSceneObject(a3_SceneObject *sceneObject, const a3boolean useZYX)
{
	if (useZYX)
...
extern inline a3i32 a3scene_rotateSceneObject(a3_SceneObject *sceneObject, const a3real speed, const a3real deltaX, const a3real deltaY, const a3real deltaZ)
{
...
extern inline a3i32 a3scene_moveSceneObject(a3_SceneObject *sceneObject, const a3real speed, const a3real deltaX, const a3real deltaY, const a3real deltaZ)
{
	if (speed && (deltaX || deltaY || deltaZ))
	{
		a3real3 delta[3];
...
extern inline void a3scene_setProjectorSceneObject(a3_SceneProjector *projector, a3_SceneObject *sceneObject)
{
	projector->sceneObject = sceneObject;
}

extern inline void a3scene_initProjector(a3_SceneProjector *projector)
{
...
extern inline void a3scene_resetModelMatrixStack(a3_SceneModelMatrixStack* model)
{
...
extern inline void a3scene_resetViewerMatrixStack(a3_SceneViewerMatrixStack* viewer)
{
...
extern inline void a3scene_updateModelMatrixStack(a3_SceneModelMatrixStack* model, a3real4x4p const projectionMat_viewer, a3real4x4p const modelMat_viewer, a3real4x4p const modelMatInv_viewer, a3real4x4p const modelMat, a3real4x4p const atlasMat)
{
	a3real4x4SetReal4x4(model->modelMat.m, modelMat);
	a3real4x4TransformInverse(model->modelMatInverse.m, modelMat);
	a3scene_quickTransposedZeroBottomRow(model->modelMatInverseTranspose.m, model->modelMatInverse.m);
	...
	a3scene_quickTransposedZeroBottomRow(model->modelViewMatInverseTranspose.m, model->modelViewMatInverse.m);
...
extern inline void a3scene_updateViewerMatrixStack(a3_SceneViewerMatrixStack* viewer, a3real4x4p const modelMat_viewer, a3real4x4p const modelMatInv_viewer, a3real4x4p const projectionMat, a3real4x4p const projectionMatInv, a3real4x4p const biasMat, a3real4x4p const biasMatInv)
{
