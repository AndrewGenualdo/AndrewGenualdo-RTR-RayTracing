...
-animal3D-SDK/ (root)                   | Root directory
	...
	-animal3D-SDK/                      | (**you are here**)
		...
		-LAUNCH_VS_DEV.bat              | Visual Studio launcher (**DEV MODE**)
...
The supported editions are 2022 (17, v143), 2019 (16, v142), 2017 (15, v141).  
THIS DISTRIBUTION SUPPORTS 2022 ONLY.
...
Update: Support for Mac and Xcode was started.
...
1. 	Make sure the DEV-SDKs submodule is up to date. **YOUR 
FRAMEWORK WILL NOT WORK IF YOU DON'T DO THIS!**

2.	To open the framework, run the batch file called 
"LAUNCH_VS_DEV.bat" in the root folder.

3. Build.

4. For subsequent launches, use "LAUNCH_VS.bat" to exclude 
the player application project, only focusing on the plugin.
	

For all uses of the framework: 
	
To open the framework at any time, follow step 3 above.
...
extremely helpful with earlier versions. Therefore there is now a tool in the 
framework to help locate VS2017+. Thanks Microsoft for this silly change.

If any Intellisense problems occur (red lines that won't go away despite 
there being no errors), close the problem instance of Visual Studio, 
...
Delete the Intellisense database (.db) file here. **DO NOT COMMIT THIS 
FILE IN VERSION CONTROL!!!**


The solution contains TWO (2) projects: 
	-animal3D-DemoPlugin: This is your back-end, hotloadable library. All of 
		your development takes place in this project; feel free to organize 
		your code files however you please.
	-animal3D-DemoPlayerApp: This is your front-end application that links your 
...
**DO NOT CHANGE ANY PROJECT SETTINGS** except to add dependencies or new files.
