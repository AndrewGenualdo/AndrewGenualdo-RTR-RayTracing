...
//-----------------------------------------------------------------------------
	...
	//	return: 0 if data could not be stored (exceeds space allocation)
	//	return: -1 if invalid params or buffer not initialized
	a3ret a3bufferFixedAppend(const a3_BufferObject* buffer, a3i32 section, const a3ui32 size, const void* data, a3ui32* start_out_opt);
	...
	//	return: 0 if data could not be stored (exceeds space allocation)
	//	return: -1 if invalid params or buffer not initialized
	a3ret a3bufferFixedAppendOffset(const a3_BufferObject* buffer, a3i32 section, const a3ui32 offset, const a3ui32 size, const void* data, a3ui32* start_out_opt);
	...
	//	return: 0 if data could not be stored (exceeds space allocation)
	//	return: -1 if invalid params or buffer not initialized
	a3ret a3bufferFixedRefill(const a3_BufferObject* buffer, a3i32 section, const a3ui32 size, const void* data);
	...
	//	return: 0 if data could not be stored (exceeds space allocation)
	//	return: -1 if invalid params or buffer not initialized
	a3ret a3bufferFixedRefillOffset(const a3_BufferObject* buffer, a3i32 section, const a3ui32 offset, const a3ui32 size, const void* data);
